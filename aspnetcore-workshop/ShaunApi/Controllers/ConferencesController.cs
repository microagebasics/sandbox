...
namespace ShaunApi.Controllers
{
  ...
  public class ConferencesController : Controller
  {
    ...
    public async Task<IActionResult> GetConferences()
    {
      ...
      var result = conferences.Select(s => new ShaunDTO.ConferenceResponse
      {
        ID = s.ID,
        Name = s.Name,
        //Sessions = ??,
    ...
    public async Task<IActionResult> GetConference([FromRoute] int id)
    {
      ...
      var result = new ShaunDTO.ConferenceResponse
      {
        ID = conference.ID,
    ...
    [HttpPost]
    public async Task<IActionResult> CreateConference([FromBody] ShaunDTO.Conference input)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> UpdateConference([FromRoute]int id, [FromBody]ShaunDTO.Conference input)
    {
      var conference = await _db.FindAsync<Conference>(id);
