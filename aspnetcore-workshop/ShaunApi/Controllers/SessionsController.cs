...
namespace ShaunApi.Controllers
{
  ...
  public class SessionsController : Controller
  {
    ...
    [HttpPost]
    public async Task<IActionResult> Post([FromBody]ShaunDTO.Session input)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Put([FromRoute]int id, [FromBody]ShaunDTO.Session input)
    {
    ...
    private static ShaunDTO.SessionResponse MapSessionResponse(Session session)
    {
